    ...
    <div id="inner">
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-5 mt-3">
                <form method="post" action="./change-password.php" class="border rounded w-100 mb-5 mx-auto px-3 pt-3 bg-light">
                    ...
                    <div class="form-group">
                        <label for="pwd2">Xác nhận lại mật khẩu mới</label>
                    ...
                    <div class="form-group">
                        ...
                        ?>
                        <button onclick="return confirmUpdate()"; name='update' class="btn btn-success px-5">Thay đổi mật khẩu</button>          
                    </div>
                </form>
            </div>
        </div>
